            ...
            <div className="navbar" style={styleObj}>
                <div className="tag">
                    <div className="luxury">
                        ...
                        <a href="/" onClick={(e) => handleHomeClick(e)} style={{marginLeft: 15}}>
                            <div>
                                <h3 style={{ color: 'white' }}>Green Haven Plants</h3>
                                <i style={{ color: 'white' }}>Your Oasis of Green Living</i>
                            </div>
                        </a>
                    </div>
                </div>
                <div style={styleObjUl}>
                    ...
                    <div> 
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                <p style={styleNumberQty}>{totalQty}</p>
                    ...
                    <div key={index}> 
                        ...
                        <div className="product-list"> 
                            {category.plants.map((plant, plantIndex) => {
                                const isAdded = cart.find(item => plant.name === item.name);
